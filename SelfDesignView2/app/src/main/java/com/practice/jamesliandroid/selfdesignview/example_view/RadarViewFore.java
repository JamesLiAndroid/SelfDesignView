package com.practice.jamesliandroid.selfdesignview.example_view;
...
import com.practice.jamesliandroid.selfdesignview.view.RadarView;

import java.util.ArrayList;
import java.util.Iterator;

public class RadarViewFore extends View {
    ...
    public RadarViewFore(Context context) {
        super(context);
        init();
    }

    public RadarViewFore(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        getAttrs(context, attrs);
        init();
    }

    public RadarViewFore(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
